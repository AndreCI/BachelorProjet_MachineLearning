...
f.Visible = 'on';
    ...
    fplot(@(x)hypothesis_display(transpose(theta_matrix_1),x/(dateMax/(3600*24)),complexity,currentFlightDur/flightDurationMax,route_nbr,month_nbr)*priceMax, Limits)
   hold on;
   fplot(@(x)hypothesis_display(transpose(theta_matrix_2),x/(dateMax/(3600*24)),complexity,currentFlightDur/flightDurationMax,route_nbr,month_nbr)*priceMax, Limits)
   hold on;
