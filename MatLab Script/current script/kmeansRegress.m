...
%Parameters
Xtotal_1 = getInput_regress(dates_1,a,flightDuration_1,routes_1, month_1);
Xtotal_2 = getInput_regress(dates_2,a,flightDuration_2,routes_2, month_2);
Xtotal_Cross = getInput_regress(dates_Cross,a,flightDuration_Cross,routes_Cross,month_Cross);
Xtotal_Test = getInput_regress(dates_Test,a,flightDuration_Test,routes_Test, month_Test);
%end parameters
...
size(Xtotal_1)
size(prices_1)
TrendError(:,1) = cost_function_regress(reg_1,Xtotal,prices);

size(reg_2)
size(Xtotal_2)
size(prices_2)
TrendError(:,2) = cost_function_regress(reg_2,Xtotal,prices);
