...
f.Visible = 'on';
    ...
    fplot(@(x)PML_hypothesis_display(transpose(theta_matrix(idx,:)),x/(dateMax/(3600*24)),complexity,currentFlightDur/flightDurationMax,route_nbr,month_nbr)*priceMax, Limits)
  %  hold on;
